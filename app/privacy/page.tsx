...
export default function Privacy() {
  return (
    <main className="policy-page">
      ...
      <h2>Who sees your page</h2>
      <p>
        Choose Everyone, Friends only, or Only me. Friendship is mutual. Private
        messages require an accepted friendship. Blocks are private, and blocked
        members lose access through database-level policies—not just hidden
        buttons.
      </p>
      ...
      <p>
        Signed-in members can download a portable account archive and
        permanently delete their account from Account &amp; Safety. Deletion
        removes the authentication account and cascades through owned profile
        data.
      </p>
      <h2>Security</h2>
      <p>
        Sessions refresh on trusted browsers so ordinary navigation does not
        repeatedly demand a password. Members can sign out on every device from
        Account &amp; Safety. Reauthentication remains appropriate for sensitive
        changes.
      </p>
      <h2>Young people</h2>
      <p>
      ...
      <h2>Contact</h2>
      <p>
        Use in-product reporting for member or content concerns. For immediate
